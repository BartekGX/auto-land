...
export default function Footer() {
    return (
        <div className="w-full border-t-2 border-gray-600 md:p-5 p-2 grid md:grid-cols-2 grid-cols-1">
            <div className="w-full flex md:justify-center">
                <div className="md:mx-auto">
                    <div className="flex flex-col gap-1">
                        <div className="flex gap-2">
                            <div className="flex">
                                <p className="text-lg">AUTOLAND Piotr Wójcik</p>
                            </div>
                            <div>
                                <p>+48 602 22 00 44</p>
                                <p>+48 572 37 00 37</p>
                        ...
                        <Link href="https://maps.app.goo.gl/3SB5pTGPmCTKRHkR7" target="_blank" className="hover:text-gray-400">
                        ...
                        <div className="flex items-center gap-1">
                            ...
                            <p className="md:text-lg text-base">auto-land@wp.pl</p>
                        </div>
                    </div>
                </div>
            </div>
