...
export default function Footer() {
    return (
        <div className="w-full border-2 border-[#27272a] rounded-t-xl md:p-5 p-2 grid md:grid-cols-2 grid-cols-1">
            <div className="w-full flex md:justify-center">
                <div className="md:mx-auto">
                    <h2 className="md:text-3xl text-xl font-bold">Kontakt</h2>
                    <div className="flex flex-col gap-1">
                        ...
                        <div className="flex items-center gap-1">
                            ...
                            <p className="md:text-lg text-base">+48 602 220 044</p>
                        </div>
                        <div className="flex items-center gap-1">
